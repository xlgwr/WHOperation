...
namespace WHOperation
{
    public class PIMLPrint
    {
            ...
            )
        {
            ...
            if (GlobalClass1.systemID.Equals("WTSZ"))
            {
                cRet.Append("^XA");
                cRet.Append("^A0N,33,34^FO769,4^FDRECV^FS");
                cRet.Append("^A0N,33,34^FO34,4^FD" + t1_type + "^FS");
                cRet.Append("^A0N,33,34^FO583,4^FD" + t1_user + "^FS");
                cRet.Append("^A0N,33,34^FO608,115^FD" + t1_RIR + "^FS");
                cRet.Append("^A0N,33,34^FO608,66^FD" + t1_part + "^FS");
                cRet.Append("^A0N,33,34^FO31,39^FD" + t1_site + "^FS");
                cRet.Append("^A0N,33,34^FO598,343^FDExpiry:" + t1_expi_date + "^FS");
                cRet.Append("^A0N,33,34^FO31,163^FDCUST:^FS");
                cRet.Append("^A0N,33,34^FO608,292^FD" + t1_qty_per2 + "    " + t1_qty_tot + "^FS");
                cRet.Append("^A0N,33,34^FO239,343^FD" + t1_ref + "^FS");
                cRet.Append("^A0N,33,34^FO402,4^FD" + t1_loc + "^FS");
                cRet.Append("^A0N,33,34^FO608,246^FD" + t1_pims_nbr + "^FS");
                cRet.Append("^A0N,33,34^FO31,198^FD" + t1_mfgr_part + "^FS");
                cRet.Append("^A0N,33,34^FO418,343^FDD/C:" + t1_date_code + "^FS");
                cRet.Append("^BY3^FO31,66^BCN,88,N,N,N^FD" + t1_RIR + "^FS");
                cRet.Append("^BY3^FO31,231^BCN,105,N,N,N^FD" + t1_pims_nbr + "^FS");
                cRet.Append("^FO21,36^GB866,5,4,B,0^FS");
                cRet.Append("^A0N,33,34^FO32,343^FD" + Form1._tfclass._tfvendorid + "^FS");
                cRet.Append("^XZ");
